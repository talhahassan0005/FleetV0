    ...
    <div className="min-h-screen bg-white">
          ...
          <div className="text-center space-y-6">
            <FadeIn direction="up" delay={0} duration={800} distance={20} blur={true}>
              <h1 className="text-4xl md:text-6xl font-bold text-white">
                Book Freight from Cape Town
              </h1>
            </FadeIn>

            <FadeIn direction="up" delay={150} duration={900} distance={30} blur={true}>
              <p className="text-lg md:text-xl text-blue-100 max-w-2xl mx-auto">
                Connect with verified transporters across South Africa. Instant quotes. Real-time tracking.
              </p>
            </FadeIn>
      ...
      <section className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <h2 className="text-3xl font-bold text-center mb-12">Popular Routes from Cape Town</h2>
          <div className="grid md:grid-cols-2 gap-6">
            {[
              ...
              <div key={i} className="rounded-lg p-6 border-2 border-emerald-200 bg-emerald-50">
                ...
                <p className="font-bold">Cape Town → {route.to}</p>
      ...
      <section ref={formRef} className="py-20 bg-slate-50">
        <div className="max-w-2xl mx-auto px-4 sm:px-6 lg:px-8">
          <h2 className="text-3xl font-bold text-center mb-12">Get Your Quote from Cape Town</h2>
          <div className="bg-white rounded-2xl p-8 border-2 border-gray-100 shadow-xl">
            <QuoteForm defaultPickup="Cape Town" />
          </div>
        </div>
      </section>
