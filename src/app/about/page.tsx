...
export default function AboutPage() {
  return (
    <div className="min-h-screen">
      ...
      <section className="py-24 bg-gradient-to-b from-slate-900 via-slate-800 to-slate-900 text-white">
          ...
          <div className="space-y-8 leading-relaxed text-lg">
            ...
            <FadeIn direction="up" delay={700} duration={900} blur={true} distance={20}>
              <div className="pt-8 border-t border-emerald-400/30">
                <p className="text-xl md:text-2xl font-bold text-emerald-400 text-center">
