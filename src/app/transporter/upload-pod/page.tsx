            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div className="bg-white/85 backdrop-blur-3xl rounded-2xl border-2 border-white/60 p-6 shadow-lg">
                ...
                <select
                  ...
                  required
                  className="w-full px-4 py-2.5 border border-gray-200 rounded-lg text-gray-600 focus:outline-none focus:border-[#3ab54a] focus:ring-2 focus:ring-[#3ab54a]/20 transition-all"
                >
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div className="bg-white/85 backdrop-blur-3xl rounded-2xl border-2 border-white/60 p-6 shadow-lg">
                  ...
                  <input
                    ...
                    required
                    className="w-full px-4 py-2.5 border border-gray-200 text-gray-600 rounded-lg focus:outline-none focus:border-[#3ab54a] focus:ring-2 focus:ring-[#3ab54a]/20 transition-all"
                  />
                </div>
